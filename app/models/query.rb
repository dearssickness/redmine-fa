...
#      sql = date_clause(db_table, db_field, date.beginning_of_month, date.end_of_month, is_custom_filter)
      ...
      sql = date_clause(db_table, db_field, jdt_elements["jtog_calendar_startdt"], jdt_elements["jtog_calendar_enddt"], is_custom_filter)
    when "lm"
      # = last month
...
#      sql = date_clause(db_table, db_field, date.beginning_of_year, date.end_of_year, is_custom_filter)
      jdt_elements = jdate_elements()      
      sql = date_clause(db_table, db_field, jdt_elements["jtog_calendar_beginning_of_year"], jdt_elements["jtog_calendar_end_of_year"], is_custom_filter)
    when "~"
  ...
  def jdate_elements()
    ...
    jdt_elements["jtog_calendar_end_of_year"] = jalali_to_gregorian(jdate_year_list[0].to_s+'-'+'12'+'-'+'29').to_date
