...
function buildFilterRow(field, operator, values) {
  ...
  case "date_past":
    tr.find('td.values').append(
      ' <span style="display:none;"><input type="text" name="v_jalali['+field+'][]" id="values_'+fieldId+'_1_jalali" size="10" class="value date_value" autocomplete="off"/></span>' +
      ' <span style="display:none;"><input type="text" name="v_jalali['+field+'][]" id="values_'+fieldId+'_2_jalali" size="10" class="value date_value" autocomplete="off"/></span>' +
      ' <input type="text" name="v['+field+'][]" id="values_'+fieldId+'_1" size="10" style="display:none" /> ' +
      ' <input type="text" name="v['+field+'][]" id="values_'+fieldId+'_2" size="10" style="display:none" /> ' +
      ' <span style="display:none;"><input type="text" name="v['+field+'][]" id="values_'+fieldId+'" size="3" class="value" /> '+labelDayPlural+'</span>'
    );
    $('#values_'+fieldId+'_1_jalali').persianDatepicker({format: 'YYYY/MM/DD', initialValue: false, altField: '#values_'+fieldId+'_1', altFormat: 'gregorian'});
    $('#values_'+fieldId+'_2_jalali').persianDatepicker({format: 'YYYY/MM/DD', initialValue: false, altField: '#values_'+fieldId+'_2', altFormat: 'gregorian'});
...
function beforeShowDatePicker(input, inst) {
  ...
  kamaDatepicker(input,{markToday: true, markHolidays: true, gotoToday: true, forceFarsiDigits: true});
}
