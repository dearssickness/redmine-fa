...
var Config = {
  ...
  'altFieldFormatter': function altFieldFormatter(unixDate) {
    var self = this,
        ...
        pd = void 0;
    if (thisAltFormat === 'gregorian' || thisAltFormat === 'g') {
      var unix_epoch_date = new Date(unixDate);
      var gYear = unix_epoch_date.getFullYear();
      var gMonth = parseInt(unix_epoch_date.getMonth()) + 1;
      if (parseInt(gMonth) < 10) {gMonth = '0'+gMonth.toString()};
      var gDay = parseInt(unix_epoch_date.getDate());
      if (parseInt(gDay) < 10) {gDay = '0'+gDay.toString()};
